...
// Feature: Supplier
// Description: Supplier ingredient price feed automation
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Supplier. Supplier ingredient price feed automation' },
