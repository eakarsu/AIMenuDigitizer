// Auto-generated feature route: inventory-menu-link
// Domain: inventory-menu autonomous linker — Capability: linking menu and inventory to reduce waste
// Mounted under: /api/inventory-menu-link
...
router.post('/run', async (req: Request, res: Response) => {
  try {
    ...
    const systemPrompt = `You are a inventory-menu autonomous linker. Your task is linking menu and inventory to reduce waste. Respond with concise JSON: { "summary": string, "recommendations": string[], "next_actions": string[], "confidence": number }.`;
