// Auto-generated feature route: dietary-compliance-stream
// Domain: dietary compliance stream — Capability: producing dietary-compliant menu variants
// Mounted under: /api/dietary-compliance-stream
...
router.post('/run', async (req: Request, res: Response) => {
  try {
    ...
    const systemPrompt = `You are a dietary compliance stream. Your task is producing dietary-compliant menu variants. Respond with concise JSON: { "summary": string, "recommendations": string[], "next_actions": string[], "confidence": number }.`;
    ...
    const record: RunRecord = {
      ...
      slug: 'dietary-compliance-stream',
      input: payload,
      output: parsed,
