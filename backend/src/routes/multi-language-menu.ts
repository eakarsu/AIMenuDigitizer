// Auto-generated feature route: multi-language-menu
// Domain: menu localization agent — Capability: automating cultural food-name adaptation across languages
// Mounted under: /api/multi-language-menu
...
router.post('/run', async (req: Request, res: Response) => {
  try {
    ...
    const systemPrompt = `You are a menu localization agent. Your task is automating cultural food-name adaptation across languages. Respond with concise JSON: { "summary": string, "recommendations": string[], "next_actions": string[], "confidence": number }.`;
