// Auto-generated feature route: menu-optimization-agent
// Domain: agentic menu optimizer — Capability: continuously updating pricing and menu engineering
// Mounted under: /api/menu-optimization-agent
...
router.post('/run', async (req: Request, res: Response) => {
  try {
    ...
    const systemPrompt = `You are a agentic menu optimizer. Your task is continuously updating pricing and menu engineering. Respond with concise JSON: { "summary": string, "recommendations": string[], "next_actions": string[], "confidence": number }.`;
