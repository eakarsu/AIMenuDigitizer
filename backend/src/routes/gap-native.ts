...
// Feature: Native
// Description: Native integration with DoorDash/Uber Eats (only generic integrations)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Native. Native integration with DoorDash/Uber Eats (only generic integrations)' },
