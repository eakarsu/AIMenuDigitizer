...
// Feature: Webhooks
// Description: Webhooks for POS events (orders, payments)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Webhooks. Webhooks for POS events (orders, payments)' },
