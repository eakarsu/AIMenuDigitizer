...
// Order
// Order ingestion entity (track popularity)

export default function GapOrder() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-order', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Order</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Order ingestion entity (track popularity)</p>
