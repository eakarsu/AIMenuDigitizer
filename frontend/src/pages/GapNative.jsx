...
// Native
// Native integration with DoorDash/Uber Eats (only generic integrations)
...
export default function GapNative() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Native integration with DoorDash/Uber Eats (only generic integrations)</p>
