...
// Qr Code
// QR-code menu delivery surface

export default function GapQrCode() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-qr-code', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Qr Code</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>QR-code menu delivery surface</p>
