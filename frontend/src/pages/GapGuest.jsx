...
// Guest
// Guest dietary preference tracking entity

export default function GapGuest() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-guest', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Guest</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Guest dietary preference tracking entity</p>
