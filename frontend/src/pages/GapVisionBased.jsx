...
// Vision Based
// Vision-based menu intelligence: upload menu image, auto-extract dishes/prices/ingredients with allergen warnings
...
export default function GapVisionBased() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Vision-based menu intelligence: upload menu image, auto-extract dishes/prices/ingredients with allergen warnings</p>
